...
public static class LocalizationService
{
    ...
    private static readonly IReadOnlyDictionary<string, string> English = new TranslationDictionary(StringComparer.Ordinal)
    {
        ...
        ["Protección TPM de la configuración"] = "TPM configuration protection",
        ["Usa una clave no exportable del TPM para proteger el estado local."] = "Use a non-exportable TPM key to protect local state.",
        ["Activa: una clave no exportable del TPM protege el estado local de este equipo."] = "On: a non-exportable TPM key protects this computer's local state.",
        ["Activar protección TPM de la configuración"] = "Enable TPM configuration protection",
        ["Desactivar protección TPM de la configuración"] = "Disable TPM configuration protection",
        ["Vincular configuración al TPM"] = "Bind configuration to TPM",
        ["La configuración de ProtectedApp se cifrará con una clave no exportable del TPM de este equipo. No protege ni modifica las bóvedas. Si se restablece el TPM, se reinstala Windows o se cambia la placa base, deberás restaurar una copia o configurar ProtectedApp de nuevo."] = "ProtectedApp configuration will be encrypted with a non-exportable key in this computer's TPM. It does not protect or modify vaults. If the TPM is reset, Windows is reinstalled, or the motherboard changes, you will need to restore a backup or set up ProtectedApp again.",
        ["Activar"] = "Enable",
        ...
        ["Protección TPM de la configuración activada"] = "TPM configuration protection enabled",
        ["Protección TPM de la configuración desactivada"] = "TPM configuration protection disabled",
