...
public static class LocalizationService
{
    ...
    private static readonly IReadOnlyDictionary<string, string> English = new TranslationDictionary(StringComparer.Ordinal)
    {
        ...
        ["PREFERENCIAS PROTEGIDAS"] = "PROTECTED PREFERENCES",
        ["Configuración de ProtectedApp"] = "ProtectedApp settings",
        ["Ajusta la protección, las credenciales y el comportamiento de la aplicación."] = "Adjust protection, credentials, and application behavior.",
        ...
        ["Protección TPM de configuración y reglas"] = "TPM protection for configuration and rules",
        ["Usa una clave no exportable del TPM para proteger la configuración, las reglas y el historial local."] = "Use a non-exportable TPM key to protect configuration, rules, and local history.",
        ["Activa: una clave no exportable del TPM protege la configuración, las reglas y el historial local de este equipo."] = "On: a non-exportable TPM key protects this computer's configuration, rules, and local history.",
        ["Activar protección TPM de configuración y reglas"] = "Enable TPM protection for configuration and rules",
        ["Desactivar protección TPM de configuración y reglas"] = "Disable TPM protection for configuration and rules",
        ["Vincular configuración y reglas al TPM"] = "Bind configuration and rules to TPM",
        ["La configuración, las reglas de aplicaciones protegidas, las preferencias y el historial de ProtectedApp se cifrarán con una clave no exportable del TPM de este equipo. No protege ni modifica las bóvedas. Si se restablece el TPM, se reinstala Windows o se cambia la placa base, deberás restaurar una copia o configurar ProtectedApp de nuevo."] = "ProtectedApp configuration, protected-application rules, preferences, and history will be encrypted with a non-exportable key in this computer's TPM. It does not protect or modify vaults. If the TPM is reset, Windows is reinstalled, or the motherboard changes, you will need to restore a backup or set up ProtectedApp again.",
        ["Activar"] = "Enable",
        ["TPM no disponible"] = "TPM unavailable",
        ["No se pudo activar la protección TPM. Comprueba que el equipo tenga un TPM disponible y que Windows permita crear claves de plataforma. La configuración actual se ha conservado con la protección anterior."] = "TPM protection could not be enabled. Check that this computer has an available TPM and that Windows allows platform keys to be created. The current configuration has been preserved with its previous protection.",
        ["No se pudo retirar la protección TPM. La configuración no se ha modificado."] = "TPM protection could not be removed. The configuration has not been changed.",
        ["Protección TPM de configuración y reglas activada"] = "TPM protection for configuration and rules enabled",
        ["Protección TPM de configuración y reglas desactivada"] = "TPM protection for configuration and rules disabled",
        ["TPM + contraseña"] = "TPM + password",
        ["Vincular esta bóveda al TPM de este equipo"] = "Bind this vault to this computer's TPM",
        ["Activa: para abrirla se requiere su contraseña y el TPM de este equipo."] = "On: opening it requires its password and this computer's TPM.",
        ["Opcional: exige contraseña y TPM. Al activarla se conserva una copia portátil previa."] = "Optional: requires password and TPM. Enabling it preserves a prior portable copy.",
        ["Protección del dispositivo"] = "Device protection",
        ["Autorizar protección TPM de bóveda"] = "Authorize vault TPM protection",
        ["Autorizar retirada de protección TPM de bóveda"] = "Authorize removal of vault TPM protection",
        ["Configuración guardada"] = "Configuration saved",
        ["Los cambios generales se guardaron, pero la protección TPM de la bóveda no se modificó."] = "The general changes were saved, but the vault TPM protection was not changed.",
        ["Vincular bóveda al TPM"] = "Bind vault to TPM",
        ["Para abrir esta bóveda será necesaria su contraseña y el TPM de este equipo. Se creará una copia portátil sin TPM antes de activarla. Si se restablece el TPM, se reinstala Windows o se cambia la placa base, usa esa copia para recuperar el acceso."] = "Opening this vault will require its password and this computer's TPM. A portable copy without TPM will be created before enabling it. If the TPM is reset, Windows is reinstalled, or the motherboard changes, use that copy to regain access.",
        ["No se pudo cambiar la protección TPM"] = "Could not change TPM protection",
        ["La bóveda conserva su protección anterior."] = "The vault retains its previous protection.",
        ["Protección TPM de bóveda activada; se conservó una copia portátil previa"] = "Vault TPM protection enabled; a prior portable copy was preserved",
        ["Protección TPM de bóveda desactivada"] = "Vault TPM protection disabled",
        ["Copia automática de configuración"] = "Automatic configuration backup",
        ["Configurar copias automáticas de configuración"] = "Configure automatic configuration backups",
        ["Activar copias automáticas"] = "Enable automatic backups",
        ["Versiones que conservar"] = "Versions to retain",
        ["Contraseña de las copias"] = "Backup password",
        ["La contraseña se guarda solo protegida por Windows en este equipo para ejecutar las copias. El archivo .pabackup sigue necesitando esa contraseña y podrás restaurarlo después de formatear si la recuerdas."] = "The password is stored only with Windows protection on this computer to run backups. The .pabackup file still requires that password, and you can restore it after formatting if you remember it.",
        ["Copias automáticas de configuración"] = "Automatic configuration backups",
        ["Elige una carpeta existente para guardar las copias automáticas."] = "Choose an existing folder for automatic backups.",
        ["Contraseña no válida"] = "Invalid password",
        ["La contraseña debe tener al menos 12 caracteres y coincidir con su confirmación."] = "The password must be at least 12 characters and match its confirmation.",
